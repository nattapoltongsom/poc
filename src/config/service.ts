...
export class ConfigService {
        ...
        const loadConfig: Config = (() => {
            return {
                db: {
                    ...
                    replicaSetName: this._getEnv(EnvironmentVariable.MONOG_REPLICA_SET_NAME),
                ...
                notification: {
                    email: {
                        ...
                        providerEmail: this._getEnv(EnvironmentVariable.EMAIL_PROVIDER_NAME),
                ...
                ssoPlatform: {
                    firster: {
                        getTokenEndpoint: this._getEnv(EnvironmentVariable.FRISTER_SSO_TOKEN_ENDPOINT),
                        clientId: this._getEnv(EnvironmentVariable.FIRSTER_SSO_CLIENT_ID),
                        clientSecret: this._getEnv(EnvironmentVariable.FIRSTER_SSO_CLIENT_SECRET),
                    ...
                    kp: {
                        ...
                        clientSecret: this._getEnv(EnvironmentVariable.KP_SSO_CLIENT_SECRET),
                        scope: this._getEnv(EnvironmentVariable.KP_SSO_CLIENT_SCOPE),
                    },
                },
                sso: {
                    validateTokenEndpoint: this._getEnv(EnvironmentVariable.LOGISTICS_SSO_INTROSPECTION_ENDPOINT),
                    clientId: this._getEnv(EnvironmentVariable.LOGISTICS_SSO_CLIENT_ID),
                    clientSecret: this._getEnv(EnvironmentVariable.LOGISTICS_SSO_CLIENT_SECRET),
                },
            }
        })()
    ...
    public getNotificationConfig(): NotificationConfig {
        return {
            email: {
                ...
                recieverEmailTest: this._configuration.notification.email.recieverEmailTest,
    ...
    public getSsoPlatformConfig(): SsoPlatformConfig {
        return {
            firster: {
                getTokenEndpoint: this._configuration.ssoPlatform.firster.getTokenEndpoint,
